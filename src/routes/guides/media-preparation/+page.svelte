...
<ProtocolLayout {title} {badges} {introColumns} {source}>
	...
	<ContentBlock title="Essential Media Components">
	...
	<ContentBlock title="Specific Media Formulations">
	...
	<ContentBlock title="Step-by-Step Media Preparation Protocol">
		...
		<ol>
			<li><strong>Dissolve Basal Salts:</strong>
				<ul>
					<li>Add appropriate volume of stock solution to distilled water</li>
					<li>Stir continuously until completely dissolved</li>
					<li>Use magnetic stirrer for consistent mixing</li>
				</ul>
			</li>
			<li><strong>Add Sucrose:</strong>
				<ul>
					<li>Add required amount of sucrose</li>
					<li>Stir until completely dissolved</li>
					<li>Ensure no crystals remain</li>
				</ul>
			</li>
			<li><strong>Add Vitamins:</strong>
				<ul>
					<li>Add vitamin stock solutions</li>
		...
		<ol>
			<li><strong>Calculate Requirements:</strong> Determine exact volumes needed based on final concentrations</li>
			<li><strong>Add Hormones:</strong> Add hormone stock solutions slowly while stirring, ensure complete dissolution</li>
		</ol>
		
		<h3>Step 4: pH Adjustment</h3>
		<ol>
			<li><strong>Initial Measurement:</strong> Use calibrated pH meter for accuracy ({displayPH(5.6)}-{displayPH(5.8)} target)</li>
			<li><strong>Adjustment Process:</strong>
				<ul>
					<li>Add 1N HCl dropwise to lower pH</li>
					<li>Add 1N NaOH dropwise to raise pH</li>
					<li>Mix thoroughly between additions</li>
				</ul>
			</li>
		</ol>
		...
		<ol>
			<li><strong>Container Filling:</strong>
				<ul>
					<li>Standard amounts: 15-20 ml per culture tube</li>
					<li>40-50 ml per culture jar</li>
				</ul>
			</li>
			<li><strong>Autoclave Settings:</strong>
				<ul>
	...
	<ContentBlock title="Advanced Techniques and Troubleshooting">
	...
	<ContentBlock title="Quality Control and Best Practices">
		...
		<p><strong>Multiplication Media:</strong></p>
		<ul>
		...
		<p><strong>Rooting Media:</strong></p>
		<ul>
